...
# Add the code to import the dependenices needed for Flask
from flask import Flask, jsonify

# Set up the database engine (access the SQLite database)
...
# Flask Setup (define Flask app)
app = Flask(__name__)

# Flask Routes
 #1. welcome route (our "root page")
